...
<div id="myCarousel3" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    ...
    <div class="item">
      <img class="img-responsive center-block" src="women1.jpg" alt="Womens" id="img">
    </div>

    <div class="item">
      <img class="img-responsive center-block" src="women 2.jpg" alt="Womens" id="img">
    </div>
...
<div id="myCarousel4" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img class="img-responsive center-block" src="boys.jpg" alt="Boys" id="img">
    </div>

    <div class="item">
      <img class="img-responsive center-block" src="boys1.jpeg" alt="Boys" id="img">
    </div>

    <div class="item">
      <img class="img-responsive center-block" src="boys2.jpg" alt="Boys" id="img">
    </div>

    <div class="item">
      <img class="img-responsive center-block" src="boys3.jpg" alt="Boys" id="img">
    </div>
  </div>
...
<div id="myCarousel5" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img class="img-responsive center-block" src="girls.jpg" alt="Girls" id="img">
    </div>

    <div class="item">
      <img class="img-responsive center-block" src="girls1.jpg" alt="Girls" id="img">
    </div>

    <div class="item">
      <img class="img-responsive center-block" src="girls2.jpg" alt="Girls" id="img">
    </div>

    <div class="item">
      <img class="img-responsive center-block" src="girls3.jpg" alt="Girls" id="img">
    </div>
  </div>
